...
<body>
<form action="/SOF3011_ASM/EditProfile" method="post"
    ...
    >
      ...
      <div class="d-flex justify-content-around">
        <button class="btn btn-secondary mb-3 px-4" disabled>Back</button>
        <button type="submit" class="btn btn-danger mb-3 px-3">Update</button>
      </div>
    </form>
</body>
</html>